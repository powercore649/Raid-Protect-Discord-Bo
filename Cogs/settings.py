...
# ------------------------------------------------------ #  
    ...
    async def settings (self, ctx):
        ...
        embed = discord.Embed(title=self.bot.translate.msg(ctx.guild.id, "settings", "SERVER_SETTINGS"), description=f"[**Serveur Discord**](https://discord.gg/MS6TMgRfqB)", color=0xdeaa0c)
